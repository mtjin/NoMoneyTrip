...
const val EXTRA_MASTER_PRODUCT = "EXTRA_MASTER_PRODUCT"
...
const val ALARM_RESERVATION_DENY_CASE6 = 6 // 여행예약 이장님 거절 알림
...
const val READ_STATE = "readState"
const val MASTER_LETTER = "masterLetter"
